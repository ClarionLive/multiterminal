 ...
 *
 * Note: hooks, agents, skills, and CLAUDE.md now live in the Claude Code plugin at
 *   %USERPROFILE%\.claude\plugins\marketplaces\multiterminal-marketplace\plugins\multiterminal\
 * The installer copies the plugin marketplace as a unit; Claude Code auto-discovers it
 * and loads the plugin's hooks.json / agents / skills automatically. No wiring needed here.
 *
