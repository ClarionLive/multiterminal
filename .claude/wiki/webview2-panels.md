...
- `HudDashboardRenderer.Initialize` — `Controls/HudDashboardPanel/HudDashboardRenderer.cs:197`
- `HudDashboardRenderer.SetProject` — `Controls/HudDashboardPanel/HudDashboardRenderer.cs:232`
- `HudDashboardRenderer.ApplyTheme` — `Controls/HudDashboardPanel/HudDashboardRenderer.cs:243`
- `HudDashboardRenderer.SetZoomFactor` — `Controls/HudDashboardPanel/HudDashboardRenderer.cs:250`
- `HudDashboardRenderer.RefreshAll` — `Controls/HudDashboardPanel/HudDashboardRenderer.cs:264`
