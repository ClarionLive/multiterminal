...
| `MCPServer/Services/` | MCP server services | **MessageBroker**, PoolCoordinator, ActivityService, StaleTaskService, SpawnService, HttpWebhookService, SessionDiscovery, ComplexityDetector, SummaryService, GlossBackfillService + GlossBackfillPlanner (auto-writes missing 🔗 Plan-tab glosses, task a455e295), AgentAttentionService (which sessions are blocked ON THE OWNER and for how long — set from `NotificationReceived`, cleared by observed main-thread activity; task 2289bb8a) |
